...
<?php echo body_open('Importando Planilha de Produtos'); ?>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card panel">
				...
				<h3 style="text-align: center; margin-top: 50px;">Como importar sua lista de produtos do Excel</h3>
				...
				<div class="card-block">
					<div style="max-width: 750px; margin: 0 auto; padding: 20px">
						...
						<p><label class="la la-check ks-icon" style="font-size: 18px; margin-right: 10px; color: #5cb85c"></label>Crie um cabecalho com as seguintes colunas: <strong>nome, custo, preco, preco_atacado, ref, estoque_inicial, estoque_minimo</strong></p>
